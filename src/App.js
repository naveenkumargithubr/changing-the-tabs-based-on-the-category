        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              updateActveTabid={this.updateActveTabid} // updating the tabid for each tab
              isActive={tabDetails.tabId === activeTabId} // is tabId is true or false to updating a style
            />
          ))}
        </ul>
